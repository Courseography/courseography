...
getEvents systemTime (Just courseTime) = do
  ...
  where
    eventsByDate ::
        (Code, Section, StartTimesByDay, EndTimesByDay, DatesByDay) -> ([String], [String], (String, String)) -> IO [String]
...
startTimesByCourse dataInOrder "Y" =
...
endTimesByCourse dataInOrder "Y" =
    endTime dataInOrder
        ++ endTime dataInOrder
