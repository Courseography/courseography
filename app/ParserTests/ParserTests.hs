...
fcesInputs = [
    ...
    , ("1.0 credits, CSE240H1/ NEW240Y1, CSE342H1, an additional 0.5 credit at the 300+ level from the Critical Studies", AND [FCES 1.0 (REQUIREMENT $ RAW ""),OR [J "CSE240H1" "",J "NEW240Y1" ""],J "CSE342H1" "", FCES 0.5 (LEVEL "300+" (DEPARTMENT "Critical Studies"))])
    ]
