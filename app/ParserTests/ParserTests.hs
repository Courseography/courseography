...
artSciInputs = [
      ("2.0 FCEs: BIO220H1 (ecology and evolutionary biology); ENV234H1, ENV334H1 (environmental biology)", J "" "")
    , ("0.5 FCE in statistics from: EEB225H1 (recommended)/ STA220H1/ STA257H1/  STA288H1/ GGR270H1/ PSY201H1", J "" "")
    ]
