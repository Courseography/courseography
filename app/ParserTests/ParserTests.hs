...
fcesInputs = [
    ...
    , ("NEW240Y1, an additional 0.5 credits at the 300 level from the Critical Studies", AND [J "NEW240Y1" "", FCES 0.5 (LEVEL "300" (REQUIREMENT $ RAW "Critical Studies"))])
    ...
    , ("2.0 credits at the 300 level", FCES 2.0 (LEVEL "300" (REQUIREMENT $ RAW "")))
