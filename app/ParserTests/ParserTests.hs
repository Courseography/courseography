...
artSciInputs = [
    ...
    , ("5 FCEs of any of the following: LIN232H1; LIN241H1; JLP315H1; LIN331H1; LIN341H1; JLP374H1", FCES "5" (AND [J "LIN232H1",J "LIN241H1",J "JLP315H1",J "LIN331H1",J "LIN341H1",J "JLP374H1"]))
