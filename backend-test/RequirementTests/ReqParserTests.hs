...
andInputs =
    ...
    , ("CSC165H1 & CSC236H1", ReqAnd [J "CSC165H1" "", J "CSC236H1" ""])
    ,
        ( "BCH377H1; BCH378H1; and permission of Department"
        , ReqAnd [J "BCH377H1" "", J "BCH378H1" "", Raw "permission of Department"]
        )
...
andorInputs =
    [
        ( "CSC148H1/CSC207H1, CSC165H1/CSC236H1"
        , ReqAnd [ReqOr [J "CSC148H1" "", J "CSC207H1" ""], ReqOr [J "CSC165H1" "", J "CSC236H1" ""]]
        )
    ,
        ( "COG250Y1 and one of: LIN232H1/LIN241H1 or JLP315H1/JLP374H1"
        , ReqAnd [J "COG250Y1" "", ReqOr [J "LIN232H1" "", J "LIN241H1" "", J "JLP315H1" "", J "JLP374H1" ""]]
        )
    ,
        ( "COG250Y1 and one of either LIN232H1/LIN241H1 or JLP315H1/JLP374H1"
        , ReqAnd [J "COG250Y1" "", ReqOr [J "LIN232H1" "", J "LIN241H1" "", J "JLP315H1" "", J "JLP374H1" ""]]
        )
    ,
        ( "COG250Y1 + one of the following: LIN232H1/LIN241H1 or JLP315H1/JLP374H1"
        , ReqAnd [J "COG250Y1" "", ReqOr [J "LIN232H1" "", J "LIN241H1" "", J "JLP315H1" "", J "JLP374H1" ""]]
        )
    ...
    ,
        ( "ARH205H1/ ARH305H1, and one of ANT100Y1/ ANT200Y1/ ANT356H1"
        , ReqAnd [ReqOr [J "ARH205H1" "", J "ARH305H1" ""], ReqOr [J "ANT100Y1" "", J "ANT200Y1" "", J "ANT356H1" ""]]
        )
    ]
...
parInputs =
    ...
    ,
        ...
        , ReqOr [J "CSC148H1" "", ReqAnd [ReqOr [J "CSC108H1" "", J "CSC120H1" ""], ReqOr [J "MAT137Y1" "", J "MAT157Y1" ""]]]
        )
    ,
        ( "STA247H1/STA255H1/STA257H1/PSY201H1/ECO227Y1, (MAT135H1, MAT136H1)/MAT137Y1/MAT157Y1"
        , ReqAnd
            [ ReqOr [J "STA247H1" "", J "STA255H1" "", J "STA257H1" "", J "PSY201H1" "", J "ECO227Y1" ""]
            , ReqOr [ReqAnd [J "MAT135H1" "", J "MAT136H1" ""], J "MAT137Y1" "", J "MAT157Y1" ""]
            ]
        )
    ]
...
fcesInputs =
    ...
    ,
        ( "2 FCEs from: MAT135H1, MAT136H1/ MAT137Y1"
        , Fces 2.0 $ Requirement $ ReqAnd [J "MAT135H1" "", ReqOr [J "MAT136H1" "", J "MAT137Y1" ""]]
        )
    ...
    ,
        ( "Completion of 9.0 credits or permission of the instructor"
        , ReqOr [Fces 9.0 (Requirement $ Raw ""), Raw "permission of the instructor"]
        )
    ,
        ( "Completion of 9.0 credits. Permission of the instructor"
        , ReqAnd [Fces 9.0 (Requirement $ Raw ""), Raw "Permission of the instructor"]
        )
    ...
    ,
        ( "1.0 credit at the 300-level from Group B: Evolutionary"
        , Fces 1.0 (ModAnd [Level "300", Department "Group B: Evolutionary"])
        )
    ,
        ( "ANT203Y1 and a 0.5 credit 300+ level course from Group B: Evolutionary"
        , ReqAnd [J "ANT203Y1" "", Fces 0.5 (ModAnd [Level "300+", Department "Group B: Evolutionary"])]
        )
    ...
    ,
        ( "14.0 credits, 3.0 credits in Anthropology"
        , ReqAnd [Fces 14.0 (Requirement $ Raw ""), Fces 3.0 (Department "Anthropology")]
        )
    ,
        ( "Completion of 14.0 credits including PSL300H1, PSL301H1, and 0.5 HMB credit at the 300-level"
        , ReqAnd
            [Fces 14.0 (Requirement $ Raw ""), J "PSL300H1" "", J "PSL301H1" "", Fces 0.5 $ ModAnd [Level "300", Department "HMB"]]
        )
    ,
        ( "1.0 credits, CSE240H1/ NEW240Y1, CSE342H1, an additional 0.5 credit at the 300+ level from the Critical Studies"
        , ReqAnd
            [ Fces 1.0 (Requirement $ Raw "")
            , ReqOr [J "CSE240H1" "", J "NEW240Y1" ""]
            , J "CSE342H1" ""
            , Fces 0.5 (ModAnd [Level "300+", Department "Critical Studies"])
            ]
        )
    ,
        ( "1.0 credits or 1.0 credit in Canadian Studies"
        , ReqOr [Fces 1.0 (Requirement $ Raw ""), Fces 1.0 (Department "Canadian Studies")]
        )
    ,
        ( "NEW240Y1, an additional 0.5 credits at the 300 level from the Critical Studies"
        , ReqAnd [J "NEW240Y1" "", Fces 0.5 (ModAnd [Level "300", Department "Critical Studies"])]
        )
    ,
        ( "At least one 0.5 credit at the 400-level or permission of the instructor"
        , ReqOr [Fces 0.5 (Level "400"), Raw "permission of the instructor"]
        )
    ...
    ,
        ( "at least one additional 0.5 credit from a 400-level CSC/BCB course"
        , Fces 0.5 (ModAnd [Level "400", ModOr [Department "CSC", Department "BCB"]])
        )
    ,
        ( "at least one additional 1.0 credit from a 300-/400-level CSC/BCB courses"
        , Fces 1.0 (ModAnd [ModOr [Level "300", Level "400"], ModOr [Department "CSC", Department "BCB"]])
        )
    , ("At least 1.0 credit must be at the 300-/400-level.", Fces 1.0 (ModOr [Level "300", Level "400"]))
    ,
        ( "At least 1.5 credit must be at the 400-level CSC or BCB courses."
        , Fces 1.5 (ModAnd [Level "400", ModOr [Department "CSC", Department "BCB"]])
        )
    ,
        ( "At least 1.5 CSC/BCB credits at the 400-level"
        , Fces 1.5 (ModAnd [Level "400", ModOr [Department "CSC", Department "BCB"]])
        )
    ,
        ( "At least 1.5 CSC/BCB credits at the 300-/400-level"
        , Fces 1.5 (ModAnd [ModOr [Level "300", Level "400"], ModOr [Department "CSC", Department "BCB"]])
        )
    ,
        ( "At least 1.5 Psychology/Canadian Studies or Group B: Evolutionary credits at the 300-/400-level"
        , Fces
            1.5
            ( ModAnd
                [ ModOr [Level "300", Level "400"]
                , ModOr [Department "Psychology", Department "Canadian Studies", Department "Group B: Evolutionary"]
                ]
            )
        )
    ]
...
gradeAftInputs =
    ...
    ,
        ( "CSC263H1 with a minimum grade of 60% or higher / CSC236H1 (75%)"
        , ReqOr [Grade "60" $ J "CSC263H1" "", Grade "75" $ J "CSC236H1" ""]
        )
...
artSciInputs =
    ...
    ,
        ( "EEB223H1/ STA220H1 (recommended)/ STA257H1 (recommended)"
        , ReqOr [J "EEB223H1" "", J "STA220H1" "recommended", J "STA257H1" "recommended"]
        )
    ,
        ( "EEB223H1 (ecology and evo), STA220H1 (recommended)/ STA257H1 (recommended)"
        , ReqAnd [J "EEB223H1" "ecology and evo", ReqOr [J "STA220H1" "recommended", J "STA257H1" "recommended"]]
        )
    ,
        ( "EEB223H1 (ecology and evo)/ STA220H1 (recommended)/ STA257H1"
        , ReqOr [J "EEB223H1" "ecology and evo", J "STA220H1" "recommended", J "STA257H1" ""]
        )
    ,
        ( "EEB223H1 (ecology and evo)/ STA220H1 (B-)/ STA257H1"
        , ReqOr [J "EEB223H1" "ecology and evo", Grade "B-" $ J "STA220H1" "", J "STA257H1" ""]
        )
    ,
        ( "0.5 FCE from: EEB225H1 (recommended)/ STA220H1 (B-)/ STA257H1/  STA288H1/ GGR270H1/ PSY201H1"
        , Fces 0.5 $
            Requirement $
                ReqOr
                    [ J "EEB225H1" "recommended"
                    , Grade "B-" $ J "STA220H1" ""
                    , J "STA257H1" ""
                    , J "STA288H1" ""
                    , J "GGR270H1" ""
    ...
    ,
        ( "MATB23H3/STA220H1 (recommended)/STA257H1 (recommended)"
        , ReqOr [J "MATB23H3" "", J "STA220H1" "recommended", J "STA257H1" "recommended"]
        )
    ]
...
programOrInputs =
    ...
    ,
        ( "Enrolment in the International Relations program or in a History major or specialist program, or permission of instructor"
        , ReqOr
            [ Program "International Relations"
            , Program "History major"
            , Program "History specialist"
            , Raw "permission of instructor"
            ]
        )
    ,
        ( "Enrolment in the International Relations program or in a History or Political Science major or specialist program"
        , ReqOr
            [ Program "International Relations"
            , Program "History major"
            , Program "History specialist"
    ...
    , -- , ("Enrolment in ASMAJ1618. A student must be in third or fourth year.", ReqAnd [Program "ASMAJ1618",Raw "A student must be in third or fourth year."])
        ...
        ( "Enrolment in the PSY Research Specialist program, and PSY309H1, and one of PSY319H1/ PSY329H1/ PSY339H1"
        , ReqAnd [Program "PSY Research Specialist", J "PSY309H1" "", ReqOr [J "PSY319H1" "", J "PSY329H1" "", J "PSY339H1" ""]]
        )
    ...
    ,
        ...
        , ReqOr [Program "International Relations Major", Program "International Relations Specialist"]
        )
    ,
        ( "Instructor’s permission required for admission to course"
        , Raw "Instructor\8217s permission required for admission to course"
        )
    ,
        ( "MGT100H1, or enrolment in the Actuarial Science Specialist or Major"
        , ReqOr [J "MGT100H1" "", Program "Actuarial Science Specialist", Program "Actuarial Science Major"]
        )
    , ("Enrolment in Psychology Minor", Program "Psychology Minor")
    ,
        ( "Enrolment in History major or permission of instructor"
        , ReqOr [Program "History major", Raw "permission of instructor"]
        )
    ,
        ( "enrolment in a science, mathematics, or engineering program"
        , ReqOr [Program "science", Program "mathematics", Program "or engineering"]
        )
    ,
        ( "enrolment in a science, mathematics, or engineering program, or permission from instructor"
        , ReqOr [Program "science", Program "mathematics", Program "or engineering", Raw "permission from instructor"]
        )
    ]
...
cgpaInputs =
    ...
    ,
        ...
        , ReqAnd [Gpa 3.3 "", Raw "permission of the Innis College Vice-Principal"]
        )
    ,
        ( "a minimum cGpa of 3.0, and an application form that includes a written proposal confirming a faculty member has agreed to supervise."
        , ReqAnd
            [ Gpa 3.0 ""
            , Raw "an application form that includes a written proposal confirming a faculty member has agreed to supervise."
            ]
        )
    ...
    ,
        ( "a CGpa of at least 1.0 and permission of the Undergraduate Coordinator"
        , ReqAnd [Gpa 1.0 "", Raw "permission of the Undergraduate Coordinator"]
        )
    , ("with a CGpa of at least 2.5", Gpa 2.5 "")
    , ("and will normally have a CGpa of at least 3.0", Gpa 3.0 "")
    ,
        ( "A minimum CGpa of 1.0, completion of 10.0 credits and permission of the College Program Director"
        , ReqAnd [Gpa 1.0 "", Fces 10.0 (Requirement $ Raw ""), Raw "permission of the College Program Director"]
        )
    ,
        ( "A minimum CGpa of 3.0, completion of 12.0 credits, and permission of the College Program Director"
        , ReqAnd [Gpa 3.0 "", Fces 12.0 (Requirement $ Raw ""), Raw "permission of the College Program Director"]
        )
    ,
        ( "A minimum CGpa of 2.5, completion of 15.0 credits, and an application are required"
        , ReqAnd [Gpa 2.5 "", Fces 15.0 (Requirement $ Raw ""), Raw "an application are required"]
        )
    ,
        ( "A minimum CGpa of 2.0 and have completed 10.0 credits and permission of College Program Director"
        , ReqAnd [Gpa 2.0 "", Fces 10.0 (Requirement $ Raw ""), Raw "permission of College Program Director"]
        )
    ]
