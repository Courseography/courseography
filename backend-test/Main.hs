...
-- import RequirementTests.RequirementTests (test_requirements)
-- import SvgTests.SvgTests (test_svg)
...
-- tests :: TestTree
-- tests = testGroup "Tests" [controllerTests, databaseTests, requirementTests]
