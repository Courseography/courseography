...
if __name__ == '__main__':
  ...
  parser.add_argument('--dcstime', action='store_const', const=True, help='only generate DCS timetable html')
  args = parser.parse_args()

  if args.dcstime:
    courses = dcsTimetableParser.getCSCcourses()
    ...
    dcsTimetableParser.parse_dcs_timetable(args.master)
