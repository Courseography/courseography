...
main = simpleHTTP nullConf $
  msum [ dir grid $ gridResponse,
         ...
         dir course $ path (\s -> liftIO $ queryCourse s) -- (queryCourse s) >>= \x -> ok $ toResponse $ x
       ]
